        ...
        <div className="navigation-options">
          <div className="nav-links">
            ...
            >
              ...
              <div
                className={`nav-dropdown ${isOfferDropdownOpen ? "open" : ""}`}
              >
            ...
            >
              ...
              >
                ...
                <Link to="https://medium.com/@tekcanon" target="_blank" className="nav-dropdown-item">
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? "active" : ""}`}>
        ...
        <nav className="mobile-nav">
          ...
          <div className="mobile-nav-item-expandable">
                ...
                <defs>
                  <clipPath id="clip0_513_3724">
                    <rect
                      ...
                      height="13"
                      fill="white"
                      transform="matrix(0 -1 1 0 0 7.5)"
                    />
                  </clipPath>
                </defs>
              </svg>
            ...
            <div
              className={`mobile-submenu ${isOfferExpanded ? "expanded" : ""}`}
            >
              <Link
                to="/mentorship"
          ...
          <Link to="https://substack.com/@tekcanon" target="_blank" className="mobile-nav-item">
            <span className="mobile-nav-text">Newsletter</span>
          </Link>
          <Link to="https://medium.com/@tekcanon" target="_blank" className="mobile-nav-item">
